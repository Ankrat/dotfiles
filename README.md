# [Yann](https://github.com/Ankrat)’s dotfiles
...
| OS | Snippet |
|:---:|:---|
| OS X | `bash -c "$(curl -LsS https://raw.github.com/Ankrat/dotfiles/master/setup.sh)"` |
| Ubuntu | `bash -c "$(wget -qO - https://raw.github.com/Ankrat/dotfiles/master/setup.sh)"` |
